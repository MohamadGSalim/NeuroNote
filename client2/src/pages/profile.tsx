  ...
  return (
    <>
      ...
      <Box overflow="hidden" p="8">
        <Center>
          <Avatar size="2xl" name="Roger Sioufi" src={profilePic} border='1px' borderColor='gray.200'>
        </Avatar>
        </Center>
        <Box textAlign="center" mt="4">
          ...
          <Box>
                        <Center>
                            <Heading as="h4" mr="4">Level 1: Time Traveller</Heading>
                            <br></br>
                                <Popover>
                                    <PopoverTrigger>
                                    ...
                                    <PopoverContent>
                                        ...
                                        <PopoverBody>The more you use NeurNnote, the closer you get to unlocking new rewards! 
            ...
            <Box display="flex" w="100%" position='relative' justifyContent="space-between">
                <Box width="10%">
                    <Image src='/bronze.png' alt='Bronze Level' width="100%" height='auto'/>
                    <Text><b>Level 1:</b> <br /> Time Traveller</Text>
                </Box>
              <AbsoluteCenter axis="both" width="70%">
                <Progress value={80} width="100%" />
              </AbsoluteCenter>
              <Box width="10%">
                <Image src='/silver.png' alt='Siver Level' width="100%" height='auto'/>
                <Text> <b>Level 2:</b>  <br /> Sound Seeker</Text>
                </Box>
            </Box>
          </Box>
        </Box>
